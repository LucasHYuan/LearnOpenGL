...
#pragma endregion 
	// load grass
	Shader grassShader("shaders/10.3.blending.vs", "shaders/10.3.blending_discard.fs");
	Shader windowShader("shaders/10.3.blending.vs", "shaders/10.3.blending_blend.fs");
	float cubeVertices[] = {
	...
	unsigned int transparentTexture = loadTexture("../assets/textures/window.png");
