...
#pragma endregion 
	// init shader
	char vertexPath[] = "shaders/10.2.stencil_test.vs";
	char fragmentPath[] = "shaders/10.2.stencil_test.fs";
	Shader ourShader(vertexPath, fragmentPath);
	Shader borderShader(vertexPath, "shaders/10.2.border.fs");
	// load model
